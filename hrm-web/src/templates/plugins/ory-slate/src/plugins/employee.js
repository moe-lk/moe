...
export const H1 = 'Employee/first-name'
export const H2 = 'Employee/last-name'
export const H3 = 'Employee/full-name'
export const H4 = 'Employee/address-line-1'
export const H5 = 'Employee/address-line-2'
export const H6 = 'Employee/address-line-3'
...
export default class FirstNamePlugin extends Plugin {
  ...
  createButton = (type, icon) => ({ editorState, onChange }: Props) => {
    ...
    return <BarButton onClick={onClick} isActive={isActive} icon={icon} type={type}/>
  }
